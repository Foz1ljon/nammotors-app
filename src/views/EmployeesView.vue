  ...
  <div>
    <a-tabs>
      ...
      <a-tab-pane key="suppliers" :tab="t('employees.tabSuppliers')">
        ...
        <a-card :bordered="false" style="margin-top: 16px">
          <a-table :data-source="suppliersStore.items" row-key="id" size="middle" :pagination="{ pageSize: 10 }">
            ...
            <a-table-column :title="t('products.colActions')" :width="100" fixed="right">
              <template #default="{ record }">
                <a-space>
                  <a-button type="text" size="small" @click="openEditSupplier(record)">
                    <template #icon><EditOutlined /></template>
                  </a-button>
                  <a-button type="text" size="small" danger @click="handleDeleteSupplier(record)">
                    <template #icon><DeleteOutlined /></template>
                  </a-button>
                </a-space>
              </template>
          ...
          <a-col :span="12">
            <a-form-item :label="t('employees.warehouseLabel')">
              <a-select
                ...
                :placeholder="t('employees.warehousePlaceholder')"
                allow-clear
